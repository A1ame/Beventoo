...
class FamilyChatApp {
    constructor() {
        ...
        this.users = new Map([
            ['mom', { id: 'mom', name: 'Мама', username: 'mama_lyuba', status: 'В сети' }],
            ['dad', { id: 'dad', name: 'Папа', username: 'papa_viktor', status: 'В сети' }],
            ['sister', { id: 'sister', name: 'Катя (сестра)', username: 'katya_sis', status: 'Не в сети' }]
        ]);
        
        this.currentChatId = null;
        this.currentView = 'contacts'; // 'contacts' или 'chat'
    ...
    // Получение сообщений для чата (демо данные)
    getMessagesForChat(chatId) {
        const demoMessages = {
            mom: [
                { id: 1, text: 'Привет! Как дела?', time: '14:25', incoming: true },
                { id: 2, text: 'Привет, мам! Все хорошо, работаю 😊', time: '14:28', incoming: false },
                { id: 3, text: 'Это замечательно! Не забывай отдыхать', time: '14:30', incoming: true }
            ],
            dad: [
                { id: 1, text: 'Как работа?', time: '13:40', incoming: true },
                { id: 2, text: 'Все отлично, папа!', time: '13:42', incoming: false },
                { id: 3, text: 'Увидимся завтра', time: '13:45', incoming: true }
            ],
            sister: [
                { id: 1, text: 'Привет! 😄', time: '12:15', incoming: true },
                { id: 2, text: 'Привет, Катя!', time: '12:18', incoming: false },
                { id: 3, text: 'Как дела?', time: '12:20', incoming: false }
            ]
        };
